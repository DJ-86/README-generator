...
function generateMarkdown(answers) {
  ...
  ${answers.license}
  ## Contributors 
  [${answers.contributors[0]}](https://www.github.com${answers.contributors[0]})
  [${answers.contributors[1]}](https://www.github.com${answers.contributors[1]})
  [${answers.contributors[2]}](https://www.github.com${answers.contributors[2]})
  [${answers.contributors[3]}](https://www.github.com${answers.contributors[3]})
  [${answers.contributors[4]}](https://www.github.com${answers.contributors[4]})
  ## Tests
  ${answers.tests}
  ## Questions
  ${answers.questions}
